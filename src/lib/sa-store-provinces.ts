...
const STORE_PROVINCE_MAP: Record<string, string> = {
  ...
  "baywestmall": EC,   // BayWest Mall is in Gqeberha (Port Elizabeth), Eastern Cape
  "bedfordcentre": GP,
  "bedfordview": GP,
  ...
  "stoneridge": GP,
  "strubens": GP,
  "strubensvallley": GP, // legacy typo key
  "strubensvalley": GP,
  "sunwardpark": GP,
  "sunnypark": GP,
  "sunnyside": GP,
